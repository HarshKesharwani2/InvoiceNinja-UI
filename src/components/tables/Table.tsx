      ...
      >
        <div
          className={classNames(
            `${props.type == "product" ? "overflow-hidden" : "overflow-hidden"} border rounded border-b border-t`,
            {
        ...
        >
          <div
            ...
            className={`${props.type == "product" ? "overflow-y-auto" : "overflow-y-auto"} rounded ${props.className}`}
            style={{
              ...props.style,
              height: manualTableHeight,
            }}
          >
            <table ref={handleTableHeight} className="min-w-full table-auto z-10">
              {props.children}
            </table>
          </div>
        </div>
